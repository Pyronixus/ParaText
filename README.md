...
* **Effet Parallaxe Dynamique :** Mouvement fluide des couches basé sur les coordonnées en temps réel de la souris (`--mouse-x` et `--mouse-y`).
...
* **Gestion des Palettes de Couleurs :** 7 presets vibrants (*Sunset Glow, Cyberpunk, Neon Acid, Mystic Forest, Ice & Fire, Deep Ocean, Volcano, Vintage*) ainsi qu'un mode **Dégradé Fluide personnalisé**.
...
1. **Clonez le dépôt :**
   ```bash
   git clone [https://github.com/votre-utilisateur/paratext.git](https://github.com/votre-utilisateur/paratext.git)